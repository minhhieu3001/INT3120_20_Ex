...
Future<List<Product>> fetchProducts() async {
  final response = await http.get((Uri.parse('http://192.168.239.1:8000/product.JSON')));
    ...
    return Scaffold(
        ...
        body: Center(
          child: FutureBuilder<List<Product>>(
            ...
            return snapshot.hasData ? ProductBoxList(items: snapshot.data!) : const Center(child: CircularProgressIndicator());
          },
          ),
        )
    );
